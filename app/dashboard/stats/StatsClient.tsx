    ...
    <>
      ...
      <div className="content">
        ...
        <div className="stat-tiles">
          ...
          <StatTile label="Активность за 7 дней" value={newInPeriod.toLocaleString("ru-RU")} sub="сообщений" accent />
          <StatTile label="Пользователей" value="1 240" sub="+186 за период" />
          <StatTile label="Конверсия в заявку" value="16,5%" sub="от диалогов" />
        </div>
